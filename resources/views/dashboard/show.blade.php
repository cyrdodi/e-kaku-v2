<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <x-breadcrumb :links="[['url' => route('dashboard.index'), 'name' => 'Dashboard']]" current="Detail" />
        </div>
    </x-slot>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm card">
                <div class="relative card-body">
                    <div class="flex gap-6">
                        ...
                        <img src="{{ str_starts_with($biodata->pas_foto_path, 'images/') ? asset($biodata->pas_foto_path) : asset('storage/' . $biodata->pas_foto_path) }}"
            ...
            <div class="flex mt-4">
                ...
                <a href="{{ route('dashboardEdit', ['biodata' => $biodata->id]) }}"
                    class="ml-4 btn btn-primary btn-outline">
                ...
                <div class="card-body">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><a href="{{ str_starts_with($biodata->ktp_path, 'images/') ? asset($biodata->ktp_path) : asset('storage/' . $biodata->ktp_path) }}"
                                    target="_blank" class="underline">{{ $biodata->ktp }}</a></td>
                        </tr>
                        <tr>
                            <th class="w-40 text-left">Ijazah</th>
                            <td><a href="{{ asset('storage/' . $biodata->ijazah_path) }}" target="_blank"
                                    class="underline">{{ $biodata->ijazah }}</a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                @if ($biodata->ijazah !== '')
                                    <a href="{{ asset('storage/' . $biodata->sertifikat_path) }}" target="_blank"
                                        class="underline">{{ $biodata->sertifikat }}</a>
                                @endif
                            </td>
                        </tr>
                    </table>
