    ...
    <body class="text-[10px]">
            ...
            <div class="w-[1133px] h-[415px] grid grid-cols-2 gap-8 p-3 ">
                ...
                <div class="">
                    <section>
                        ...
                        <div>{{ $cetakTrans->biodata->institusi_pendidikan }} Th.
                            {{ $cetakTrans->biodata->tahun_lulus }}</div>
                ...
                <div>
                    ...
                    <div>
                        <div class="relative flex">
                            ...
                            <div>
                                ...
                                <div class="font-semibold text-center text-[14px]">DINAS TENAGA KERJA DAN TRANSMIGRASI
                                </div>
                                <div class="text-xs text-center">Jl. Raya Labuan KM. 4 Cipacung Pandeglang, Kaduhejo,
                                    Kabupaten
                                    Pandeglang</div>
                                <div class="text-xs text-center">Provinsi Banten 42253 Telp: (0253) 202038</div>
                            </div>
                            <div class="absolute top-0 right-0 p-1 font-semibold bg-white border rounded-lg">Kartu AK/1
                            </div>
                        </div>
                    </div>

                    <div
                        class="px-2 py-1 my-1 font-semibold text-center border border-gray-800 rounded-lg border-sm text-[14px]">
                        KARTU
                        TANDA BUKTI
                        PENDAFTARAN PENCARI
                        KERJA</div>
                        ...
                        <table class="text-[12px] w-full">
                            <tr>
                                ...
                                <th class="flex justify-around gap-2">
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $noPen1 }}</span>
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $noPen2 }}</span>
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $noPen3 }}</span>
                                </th>
                            </tr>
                            <tr class="">
                                ...
                                <th class="flex justify-around gap-2 text-right">
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $group1 }}</span>
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $group2 }}</span>
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $group3 }}</span>
                                    <span
                                        class="px-1 tracking-widest border border-gray-700">{{ $group4 }}</span>
                                </th>
                            </tr>
                        </table>
                    </section>
                    ...
                    <section>
                        <div class="flex gap-6">
                            {{-- foto dan ttd --}}
                            <div class="">
                                <img src="{{ str_starts_with($cetakTrans->biodata->pas_foto_path, 'images/') ? asset($cetakTrans->biodata->pas_foto_path) : asset('storage/' . $cetakTrans->biodata->pas_foto_path) }}"
                                    alt="Pas Foto" class="w-[113] max-h-[151px] object-cover rounded-lg mb-2"></a>
                            ...
                            <div>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>{{ $cetakTrans->biodata->tempat_lahir }} /
                                            {{ date('d-m-Y', strtotime($cetakTrans->biodata->tanggal_lahir)) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td>:</td>
                                        <td>{{ $cetakTrans->biodata->jenis_kelamin == 'l' ? 'Laki-laki' : 'Perempuan' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Status</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-text-top">
                                            {{ $cetakTrans->biodata->alamat .
                                                ', RT/RW ' .
                                                $cetakTrans->biodata->rtrw .
                                                ', ' .
                                                $cetakTrans->biodata->kelurahan .
                                                ', ' .
                                                $cetakTrans->biodata->kecamatan->name .
                                                ', ' .
                                                $cetakTrans->biodata->kabupaten .
                                                ', ' .
        ...
        <div class="flex justify-center ">
            <div class="flex justify-between p-4 mt-8 noprint w-[1133px] border-t ">
                <a href="{{ route('dashboardShow', ['biodata' => $cetakTrans->biodata->id]) }}"
                    class="btn btn-secondary noprint" on>
